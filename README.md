...
## Float data type
<img width="1200" height="247" alt="image" src="https://github.com/user-attachments/assets/459b3e13-b8a0-49ac-b43e-d6e62548c60b" />


## Integer data type
<img width="1280" height="233" alt="image" src="https://github.com/user-attachments/assets/f3170116-5b4e-417e-b1ce-2512194a1d9c" />



## RESULT:
The host took 0.865896 seconds for integer and 0.936444 seconds for float to complete it’s computation, while the GPU outperforms the host and completes the integer computation in 0.025777 seconds and float computation in 0.013805 seconds. The GPU achieved a speedup of approximately 33.6× for integer operations and 67.8× for floating-point operations compared to the CPU.Thus, matrix summation using 2D grids and 2D blocks has been performed successfully.
